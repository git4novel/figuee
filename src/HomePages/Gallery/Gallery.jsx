...
const Gallery = () => {
  return (
    <div className='mx-auto mt-6 mb-6'>
        <h1 className='text-center p-4 text-4xl font-bold' style={{ fontFamily: 'Pacifico, cursive' }}>Top Product In Galleries</h1>
      <div className="shadow-2xl gallery grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 text-center">
        <div className="h-24 w-36 lg:w-[300px] shadow-2xl lg:h-[250px] gallery-item relative">
          <p  className='absolute bottom-0 m-1  right-1 pad font-bold'>Batman Clay Figure</p>
        ...
        <div className="h-24 w-36 shadow-xl lg:w-[300px] lg:h-[250px] gallery-item relative">
          <p  className='absolute bottom-0 m-1 right-1 font-bold'>Plane Figure</p>
        ...
        <div className=" h-24 w-36 shadow-xl lg:w-[300px] lg:h-[250px] gallery-item relative">
          <p  className='absolute bottom-0 m-1  right-1 pad font-bold'>SpiderMen Figure</p>
        ...
        <div className="h-24 w-36 shadow-xl lg:w-[300px] lg:h-[250px] gallery-item relative">
          <p  className='absolute bottom-0 m-1  right-1 pad font-bold'>Marvel toy</p>
